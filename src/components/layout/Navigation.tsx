      ...
      <div className="fixed top-0 left-0 right-0 z-[60] flex justify-center pt-4 md:pt-6 pointer-events-none">
        <nav
          className={`
            ...
            ${scrolled
              ? 'w-[min(92%,400px)] bg-white/85 backdrop-blur-md shadow-[0_4px_24px_rgba(0,0,0,0.06)] rounded-full px-4 py-2 border border-white/40' // Adjusted padding for mobile
