      ...
      <div className="container mx-auto px-6 md:px-12 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          <div className="max-w-2xl text-left order-2 lg:order-1">
            ...
            {/* Badge */}
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-indigo-50 border border-indigo-100 mb-4 animate-[fadeIn_1s_ease-out]">
            ...
            {/* Headline */}
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold tracking-[-0.03em] leading-[1.05] text-slate-900 mb-4">
              <span className="block opacity-0 animate-[slideUp_0.8s_0.2s_forwards]">
                Engineering.
              </span>
              <span className="block text-transparent bg-clip-text bg-linear-to-r from-indigo-600 via-violet-600 to-rose-500 opacity-0 animate-[slideUp_0.8s_0.4s_forwards] pb-2">
                Evolved.
              </span>
            </h1>

            {/* Subcopy */}
            <p className="text-sm md:text-base text-slate-500 max-w-lg mb-6 leading-relaxed opacity-0 animate-[fadeIn_0.8s_0.8s_forwards]">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 opacity-0 animate-[fadeIn_0.8s_1s_forwards]">
              <Link
                to="/contact"
                className="group relative px-6 py-3 bg-slate-900 text-white rounded-full font-bold text-base transition-all hover:shadow-[0_10px_30px_-10px_rgba(15,23,42,0.3)] hover:-translate-y-1 hover:bg-slate-800"
              >
              ...
              <Link to="/case-studies" className="px-6 py-3 bg-slate-100 text-slate-600 font-bold text-base rounded-full hover:bg-slate-200 transition-all hover:-translate-y-1">
                View Case Studies
              </Link>
            </div>
          </div>
          ...
          <div className="relative order-1 lg:order-2 perspective-container opacity-0 animate-[fadeIn_1s_0.5s_forwards]">
            ...
            <div className="relative aspect-square md:aspect-4/3 flex items-center justify-center">
              ...
              <div className="relative z-10 isometric-scene transform scale-[0.5] sm:scale-[0.6] md:scale-[0.7] lg:scale-[0.8] xl:scale-[0.85] transition-transform duration-500">
                ...
                <div className="relative transform-style-3d rotate-x-60 rotate-z-[-45] rotate-y-0">
                  ...
                  <div className="w-[340px] h-[200px] bg-white rounded-3xl shadow-[0_30px_60px_-15px_rgba(0,0,0,0.15),0_0_0_1px_rgba(0,0,0,0.05),0_12px_0_#e2e8f0] flex flex-col p-4 gap-4 transition-transform hover:-translate-y-2 duration-500 group-hover:shadow-[0_40px_80px_-20px_rgba(0,0,0,0.2)]">
                    ...
                    <div className="flex gap-4 h-16">
                      ...
                      <div className="flex-1 bg-slate-900 rounded-2xl shadow-[inset_0_2px_10px_rgba(0,0,0,0.5)] flex items-center px-4 overflow-hidden relative">
                        <div className="w-full h-1 bg-slate-800 rounded-full overflow-hidden relative z-10">
                          <div className="h-full bg-linear-to-r from-green-400 to-indigo-500 w-2/3 animate-[loading_2s_ease-in-out_infinite]" />
                        </div>
                    ...
                    <div className="flex gap-4 flex-1">
                      ...
                      {/* Key 2: Ship (Primary) */}
                      <div className="flex-[1.5] bg-linear-to-br from-indigo-500 to-violet-600 rounded-2xl shadow-[0_8px_0_#4338ca] flex flex-col items-center justify-center cursor-pointer hover:brightness-110 active:shadow-none active:translate-y-[8px] transition-all relative overflow-hidden">
                  ...
                  <div className="absolute -top-16 left-8 w-24 h-24 bg-white rounded-2xl shadow-[0_20px_40px_rgba(0,0,0,0.1),0_8px_0_#e2e8f0] flex items-center justify-center border border-indigo-55 animate-float">
