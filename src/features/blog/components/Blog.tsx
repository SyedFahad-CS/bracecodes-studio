...
import { allPostsQuery } from '@/features/blog/api/queries';
import { getOptimizedImageUrl } from '@/shared/utils/image';
import type { SanityBlogPost } from '@/features/blog/types';
    ...
    return (
        <div className="pt-32 pb-20 container mx-auto px-6 md:px-12 min-h-screen">
            <Helmet>
                ...
                <meta name="description" content="Engineering patterns, design systems, serverless architectures, and technical strategies from the Bracecodes team." />
                <meta property="og:title" content="Blog & Insights | Bracecodes" />
                <meta property="og:description" content="Engineering patterns, design systems, serverless architectures, and technical strategies from the Bracecodes team." />
            </Helmet>
                        ...
                        <Link to={`/blog/${post.slug.current}`} key={post._id} className="group block">
                            <article className="bg-white rounded-2xl border border-slate-200 overflow-hidden hover:border-indigo-200 hover:shadow-xl hover:shadow-indigo-500/5 transition-all duration-300 h-full flex flex-col">
                                ...
                                <div className="aspect-video relative overflow-hidden">
                                    {post.mainImage ? (
                                        <img
                                            src={getOptimizedImageUrl(post.mainImage, 800, 80)}
