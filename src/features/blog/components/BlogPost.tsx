...
import { postBySlugQuery } from '@/features/blog/api/queries';
import { getOptimizedImageUrl } from '@/shared/utils/image';
import type { SanityBlogPostFull } from '@/features/blog/types';
        ...
        image: ({ value }) => {
            ...
            return (
                <figure className="my-12">
                    <img
                        src={getOptimizedImageUrl(value, 1200, 90)}
                        alt={value.alt || ''}
    ...
    return (
        <article className="min-h-screen bg-white">
            <Helmet>
                ...
                <meta property="og:title" content={`${post.title} | Bracecodes`} />
                <meta property="og:description" content={post.excerpt} />
                {post.mainImage && (
                    <meta property="og:image" content={getOptimizedImageUrl(post.mainImage, 1200)} />
                )}
            </Helmet>
            {/* Minimal Header */}
            ...
            {post.mainImage && (
                <div className="container mx-auto px-6 max-w-5xl mb-20">
                    ...
                    >
                        <img
                            src={getOptimizedImageUrl(post.mainImage, 1600, 90)}
