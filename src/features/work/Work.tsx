...
import { featuredProjectsQuery, urlFor } from '../../lib/sanity';
  ...
  return (
    <section className="py-32 bg-slate-50 relative border-t border-slate-200">
      ...
      <div className="container mx-auto px-6 md:px-12 relative z-10">
        ...
        {/* Filter Controls */}
        <div className="mb-16 animate-[fadeIn_0.5s_0.4s_forwards] opacity-0 flex justify-center md:justify-start w-full overflow-hidden">
          <div className="w-full overflow-x-auto pb-4 -mb-4 scrollbar-hide flex md:block justify-center md:justify-start">
            <div className="inline-flex flex-nowrap gap-2 bg-white p-1.5 rounded-full border border-slate-200 shadow-sm mx-auto md:mx-0 min-w-min">
