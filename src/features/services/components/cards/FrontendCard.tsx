...
const FrontendCard: React.FC = () => {
    return (
        <ScrollReveal delay={100} className="group h-full">
            <div className="bg-[#0F172A] rounded-3xl p-5 h-full relative overflow-hidden border border-slate-800 shadow-2xl flex flex-col justify-between group hover:shadow-indigo-500/20 transition-all duration-700">
                {/* Visual Artifact: Code Window */}
                <div className="relative w-full h-[150px] bg-[#1E293B] rounded-xl border border-slate-700/50 overflow-hidden font-mono text-[11px] shadow-inner transform group-hover:scale-[1.02] transition-transform duration-500">
                    {/* Window Bar */}
                    ...
                    {/* Code Content */}
                    <div className="p-3 text-slate-300 leading-normal">
                        ...
                        <div>{'}'}</div>
                        {/* Cursor */}
                        <div className="w-2 h-4 bg-blue-400 absolute bottom-4 left-12 animate-pulse" />
                    </div>
                </div>

                <div className="mt-2.5">
                    <h3 className="text-base md:text-lg font-bold text-white mb-0.5">Frontend Dev</h3>
