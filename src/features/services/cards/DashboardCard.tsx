...
const DashboardCard: React.FC = () => {
    return (
        <ScrollReveal delay={200} className="group">
            <div className="bg-white rounded-[2.5rem] p-8 h-full relative overflow-hidden border border-slate-100 shadow-[0_20px_40px_-15px_rgba(0,0,0,0.05)] hover:shadow-[0_40px_80px_-20px_rgba(16,185,129,0.15)] transition-all duration-700 flex flex-col">
                {/* Visual Artifact: Chart */}
                <div className="relative mb-6 bg-slate-50 rounded-2xl p-5 border border-slate-100">
                    <div className="flex justify-between items-start mb-6">
                        <div>
                            <div className="text-sm text-slate-400 font-medium mb-1">Total Revenue</div>
                            <div className="text-3xl font-bold text-slate-900">$54,230</div>
                        </div>
                ...
                <div className="mt-auto">
                    <h3 className="text-2xl font-bold text-slate-900 mb-2">Dashboards & SaaS</h3>
